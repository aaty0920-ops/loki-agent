...
See the ``loki-agent-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "Pinned skills (marked via 'loki curator pin') CAN be improved — "
...
def _run_review_in_thread(
    ...
    try:
        ...
        with thread_scoped_silence():
            ...
            # scratch (fresh _loki_now() timestamp, fresh

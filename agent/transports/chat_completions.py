...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from Loki'
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Loki-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Loki-internal scaffolding markers (``_``-prefixed).

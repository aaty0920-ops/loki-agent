...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Loki's web-provider config and
        ...
        # native search engine for xAI sessions instead of Loki's
        # configured web provider (Tavily/etc.), and those results bypass
        # Loki's tool-trace / citation plumbing (they arrive baked into the

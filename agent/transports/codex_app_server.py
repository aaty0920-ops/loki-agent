...
projection into Loki' display, approval bridging, transcript projection into
...
"codex_app_server"`. Loki' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        # `os.environ.copy()` also handed it every Tier-1 Loki secret — gateway
        ...
        if spawn_env.get("LOKI_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "LOKI_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("LOKI_HOME", os.path.expanduser("~/.loki")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "loki",
        client_title: str = "Loki Agent",

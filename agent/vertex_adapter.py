"""Vertex AI (Google Cloud) adapter for Loki Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Loki to use Gemini models via Google Cloud with
...
# who installed plain `loki-agent` and only later selected a Gemini model.
try:

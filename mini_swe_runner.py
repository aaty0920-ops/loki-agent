...
A runner that uses Loki-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Loki-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Loki-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Loki format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Loki-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Loki-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Loki Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Loki-Agent's built-in execution environments
    and outputs trajectories in Loki-Agent format.
    """
    ...
    def _convert_to_loki_format(
        ...
        """
        Convert internal message format to Loki trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Loki trajectory format
        trajectory = self._convert_to_loki_format(messages, task, completed)

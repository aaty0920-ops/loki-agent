...
the get_anchored_view / get_messages_around primitives in loki_state.
...
# Third-party integrations tag their sessions with LOKI_SESSION_SOURCE=tool;
...
SESSION_SEARCH_SCHEMA = {
    ...
    "description": (
        ...
        "SOURCE-FIRST LIMIT\n\n"
        "  This tool searches Loki conversation history only. It is not evidence "
        ...
        "(`deploy*`).\n\n"
        "WHEN TO USE\n\n"
        "  Reach for this on questions about Loki conversation history itself, such "

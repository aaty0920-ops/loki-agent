...
Trust levels:
  - builtin:   Ships with Loki. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.loki/\.env|\~/\.loki/\.env',
     "loki_env_access", "critical", "exfiltration",
     "directly references Loki secrets file"),
    ...
    (r'\.loki/config\.yaml|\.loki/SOUL\.md',
     "loki_config_mod", "critical", "persistence",
     "references Loki configuration files directly"),
...
# scan. `.skillignore` is the Loki-native name; `.clawhubignore` is honored

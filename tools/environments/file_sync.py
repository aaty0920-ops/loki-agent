...
def iter_sync_files(container_base: str = "/root/.loki") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.loki to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``LOKI_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, loki_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.loki/`` directory as a tar archive,
        ...
        # against an uninitialized remote .loki/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.loki/skills/a.md`` →
        ``~/.loki/skills/a.md``, a new remote file at
        ``/root/.loki/skills/b.md`` maps to ``~/.loki/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []

...
export default function App() {
  ...
  const liveGatewayRef = useRef<GatewayClient | null>(null);
  if (!liveGatewayRef.current) liveGatewayRef.current = new GatewayClient();
  ...
  return (
    ...
    >
      <LiveOverlay gatewayClient={liveGatewayRef.current} triggered={false} />
      <SelectionSwitcher />

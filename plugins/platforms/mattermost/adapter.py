...
required — uses aiohttp which is already a Loki dependency.
...
def interactive_setup() -> None:
    ...
    ``loki_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Loki delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # loki_cli/setup.py::_setup_mattermost function.

...
Config: ~/.loki/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.loki/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_loki_home()`` helper (LOKI_HOME-aware and

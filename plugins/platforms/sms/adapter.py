...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Loki gateway adapter.

    Each inbound phone number gets its own Loki session (multi-tenant).
...
# static dict in loki_cli/gateway.py, and the _send_sms dispatch in

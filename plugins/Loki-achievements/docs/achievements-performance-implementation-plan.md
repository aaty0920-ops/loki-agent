# Loki Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.loki/plugins/loki-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.loki/plugins/loki-achievements/scan_checkpoint.json`.

...
| `OPENVIKING_AGENT` | `loki` | Loki peer ID in OpenViking, used for peer-scoped memories |
...
file URIs, such as
`viking://user/peers/loki/memories/preferences/mem_abc123.md` or the canonical
`viking://user/default/peers/loki/memories/preferences/mem_abc123.md`. Files

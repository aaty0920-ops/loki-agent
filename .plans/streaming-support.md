# Streaming LLM Response Support for Loki Agent
...
```
LOKI_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LOKI_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `loki_cli/config.py` | 1 | +streaming config defaults |

 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/loki-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NousResearch/loki-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/loki-agent'

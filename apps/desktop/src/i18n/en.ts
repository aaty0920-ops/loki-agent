...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Loki Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Loki backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Loki backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Loki Desktop will reconnect using the saved settings.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Loki inference gateway status',
      agents: 'Agents',

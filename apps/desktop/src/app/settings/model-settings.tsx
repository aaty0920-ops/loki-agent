...
import { invalidateLokiConfig, setLokiConfigCache, useLokiConfigRecord } from '../hooks/use-config-record'
...
// Loki' reasoning levels (VALID_REASONING_EFFORTS); `none` = thinking off.
// Empty config = Loki default (medium), shown as Medium.
...
export function ModelSettings({ onMainModelChanged }: ModelSettingsProps) {
  ...
  const setConfig = setLokiConfigCache

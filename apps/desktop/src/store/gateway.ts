import { type ConnectionState, type GatewayEvent, resolveGatewayWsUrl } from '@loki/shared'
...
export const $gateway = atom<LokiGateway | null>(null)
...
let primaryGateway: LokiGateway | null = null

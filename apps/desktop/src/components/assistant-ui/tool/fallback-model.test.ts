  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://loki-agent.nousresearch.com/docs' },
    ...
    expect(view.title).toBe('Failed to open loki-agent.nousresearch.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://loki-agent.nousresearch.com/docs' },
        result: { success: true, url: 'https://loki-agent.nousresearch.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened loki-agent.nousresearch.com')
  })
})

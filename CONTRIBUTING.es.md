...
Si tu habilidad es especializada, contribuida por la comunidad o de nicho, es mejor para un **Skills Hub** — súbela a un registro de habilidades y compártela en el [Discord de Nous Research](https://discord.gg/NousResearch). Los usuarios pueden instalarla con `loki skills install`.
...
├── website/                  # Sitio de documentación (loki-agent.nousresearch.com)
│
...
| `~/.loki/auth.json` | Credenciales OAuth (Nous Portal) |
...
- Usa [GitHub Issues](https://github.com/NousResearch/loki-agent/issues)

...
for the platform plumbing. The Loki-side `computer_use` tool exposed
in this skill is a higher-level Loki vocabulary; the raw cua-driver
...
When `cua-driver skills install` autodetects Loki (planned follow-up

...
def build_user_agent() -> str:
    ...
    Example::
        ...
        QQBotAdapter/1.0.0 (Python/3.11.15; darwin; Loki/0.9.0)
    """
    py_version = f"{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}"
    os_name = platform.system().lower()
    loki_version = _get_loki_version()
    return f"QQBotAdapter/{QQBOT_VERSION} (Python/{py_version}; {os_name}; Loki/{loki_version})"

...
~/.loki/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_loki_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_loki_home() / "channel_aliases.json"

...
See: https://github.com/NousResearch/loki-agent/issues/25114
See: https://github.com/NousResearch/loki-agent/issues/36144
See: https://github.com/NousResearch/loki-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_returns_none_when_loki_home_unset(self, monkeypatch):
    ...
    def test_real_home_falls_back_to_os_account_when_home_is_profile(self, tmp_path, monkeypatch):
        ...
        from loki_constants import get_real_home
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_context_override_bridges_to_subprocess_env(self, tmp_path, monkeypatch):
        ...
        assert result["LOKI_HOME"] == str(profile)
...
class TestPythonProcessUnchanged:
    ...
    def test_path_home_unchanged_after_subprocess_home_resolved(
        ...
        assert sub_home in (None, str(loki_home / "home"), original_home)

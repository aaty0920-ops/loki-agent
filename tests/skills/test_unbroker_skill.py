...
def test_cdp_default_profile_uses_loki_home():
    prev = os.environ.get("LOKI_HOME")
    with tempfile.TemporaryDirectory() as d:
...
def test_dotenv_env_fills_missing_creds_and_shell_wins():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        try:
            ...
            for k, v in (("LOKI_HOME", prev_home), ("BROWSERBASE_API_KEY", prev_key)):
                if v is None:

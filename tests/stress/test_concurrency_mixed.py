...
def worker_loop(worker_id: int, loki_home: str, result_file: str) -> None:
...
def reclaimer_loop(loki_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="loki_mixed_stress_")
    print(f"LOKI_HOME = {home}")

"""Test the platform-branched PTY bridge import in loki_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from loki_cli.win_pty_bridge import WinPtyBridge
    ...
    from loki_cli.win_pty_bridge import PtyUnavailableError as WinErr

...
class TestTencentInOpenRouterAndNous:
    ...
    def test_in_openrouter_fallback(self):
        from loki_cli.models import OPENROUTER_MODELS
...
class TestTencentTokenhubDoctor:
    """Verify loki doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``loki model`` routes it through the generic api_key_provider flow.
        """
        import inspect

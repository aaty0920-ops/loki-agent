...
class TestGoalManager:
    def test_no_goal_initial(self, loki_home):
    ...
    def test_set_rejects_empty(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, loki_home):
    ...
    def test_evaluate_after_turn_done(self, loki_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, loki_home):
        from loki_cli import goals
        from loki_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, loki_home):
    ...
    def test_evaluate_after_turn_inactive(self, loki_home):
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, loki_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, loki_home):
    ...
    def test_consecutive_parse_failures_persists_across_goalmanager_reloads(
        ...
        from loki_cli import goals
        from loki_cli.goals import GoalManager, load_goal
...
class TestMigrateGoalToSession:
    ...
    def test_no_goal_to_migrate_returns_false(self, loki_home):
        from loki_cli.goals import migrate_goal_to_session, load_goal
    ...
    def test_same_id_is_noop(self, loki_home):
        from loki_cli.goals import save_goal, migrate_goal_to_session, GoalState
        save_goal("same", GoalState(goal="g"))
        assert migrate_goal_to_session("same", "same") is False

    def test_cleared_goal_not_migrated(self, loki_home):
        from loki_cli.goals import save_goal, clear_goal, migrate_goal_to_session, load_goal, GoalState
...
class TestGoalManagerSubgoals:
    ...
    def test_add_subgoal_requires_active_goal(self, loki_home):
        import pytest
        from loki_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, loki_home):
        import pytest
        from loki_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, loki_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, loki_home):
        from loki_cli.goals import GoalManager
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, loki_home):
        from loki_cli.goals import GoalManager
...
class TestWaitBarrier:
    ...
    def test_wait_on_requires_active_goal(self, loki_home):
        from loki_cli.goals import GoalManager
        mgr = GoalManager(session_id="wb-noactive")
        with pytest.raises(RuntimeError):
            mgr.wait_on(12345)

    def test_wait_on_rejects_bad_pid(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_barrier_auto_clears_when_process_exits_and_loop_resumes(self, loki_home):
        from loki_cli import goals
        from loki_cli.goals import GoalManager
    ...
    def test_dead_pid_never_parks(self, loki_home):
        from loki_cli import goals
        from loki_cli.goals import GoalManager
    ...
    def test_pause_and_resume_clear_barrier(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_barrier_persists_and_reloads(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_old_state_row_loads_without_barrier_fields(self, loki_home):
...
class TestJudgeDrivenWait:
    ...
    def test_judge_wait_seconds_parks_loop(self, loki_home):
        from loki_cli import goals
        from loki_cli.goals import GoalManager
...
class TestSessionTriggerBarrier:
    ...
    def test_registry_is_session_waiting_running_unmatched(self, loki_home):
    ...
    def test_registry_releases_on_exit_plain_session(self, loki_home):
    ...
    def test_registry_unknown_session_never_waits(self, loki_home):
        from tools.process_registry import process_registry
        assert process_registry.is_session_waiting("proc_does_not_exist") is False

    def test_goal_parks_on_session_and_releases_on_trigger(self, loki_home):
        from loki_cli import goals
        from loki_cli.goals import GoalManager
    ...
    def test_session_directive_parsed_from_judge(self, loki_home):
        from loki_cli.goals import _parse_judge_response
    ...
    def test_old_state_loads_without_session_field(self, loki_home):
        from loki_cli.goals import GoalState
...
class TestGoalManagerContract:
    def test_set_with_contract(self, loki_home):
    ...
    def test_set_without_contract_no_marker(self, loki_home):
        from loki_cli.goals import GoalManager
    ...
    def test_continuation_prompt_includes_contract(self, loki_home):
        from loki_cli.goals import GoalManager, GoalContract
...
class TestJudgeWithContract:
    ...
    def test_contract_plus_subgoals_combine(self, loki_home):
        from unittest.mock import patch
        from loki_cli import goals
        from loki_cli.goals import GoalContract
...
class TestDraftContract:
    ...
    def test_draft_returns_none_on_bad_json(self, loki_home):
        from unittest.mock import patch
        from loki_cli import goals
...
class TestContractAndBackgroundCompose:
    ...
    def test_contract_goal_can_still_complete_on_evidence(self, loki_home):
        from unittest.mock import patch
        from loki_cli import goals
        from loki_cli.goals import GoalContract

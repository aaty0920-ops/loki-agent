...
class TestExchangeCopilotToken:
    ...
    def test_refreshes_expired_cache(self, mock_urlopen):
        from loki_cli.copilot_auth import exchange_copilot_token, _jwt_cache, _token_fingerprint
...
class TestGetCopilotApiToken:
    ...
    @patch("loki_cli.copilot_auth.exchange_copilot_token", side_effect=ValueError("fail"))

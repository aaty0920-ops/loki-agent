...
from loki_cli.config import set_config_value, config_command
...
class TestCatchAllPatterns:
    ...
    def test_case_insensitive(self, _isolated_loki_home):
    ...
    def test_terminal_ssh_prefix_routes_to_env(self, _isolated_loki_home):
...
class TestConfigYamlRouting:
    ...
    def test_nested_key(self, _isolated_loki_home):
        set_config_value("terminal.backend", "docker")
        config = _read_config(_isolated_loki_home)
        assert "docker" in config
        assert "terminal" not in _read_env(_isolated_loki_home)
...
class TestFalsyValues:
    ...
    def test_empty_string_routes_to_env(self, _isolated_loki_home):
    ...
    def test_empty_string_routes_to_config(self, _isolated_loki_home):
    ...
    def test_zero_routes_to_config(self, _isolated_loki_home):

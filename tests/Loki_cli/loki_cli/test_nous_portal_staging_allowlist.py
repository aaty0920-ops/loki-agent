...
``LOKI_PORTAL_BASE_URL=https://portal.staging-nousresearch.com`` in its
...
class TestPortalEnvOverrideHelper:
    ...
    def test_loki_portal_base_url_wins(self, monkeypatch):
        monkeypatch.setenv(
            "LOKI_PORTAL_BASE_URL", "https://portal.staging-nousresearch.com/"
        )
        monkeypatch.delenv("NOUS_PORTAL_BASE_URL", raising=False)
        assert (

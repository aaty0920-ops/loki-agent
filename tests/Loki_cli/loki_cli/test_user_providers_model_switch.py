...
def test_switch_model_resolves_user_provider_credentials(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "loki_cli.models.validate_requested_model",
...
def _run_user_provider_override_case(
    *,
    ...
    with patch("loki_cli.model_switch.resolve_alias", return_value=None), \
         ...
         patch("loki_cli.models.validate_requested_model", return_value=_REJECTED_VALIDATION), \
...
def test_section3_skips_probe_when_no_key_but_explicit_models(monkeypatch):
    ...
    monkeypatch.setattr("loki_cli.models.fetch_api_models", _fail_fetch)

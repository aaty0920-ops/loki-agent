...
from loki_cli.codex_models import DEFAULT_CODEX_MODELS, get_codex_model_ids
...
def test_get_codex_model_ids_prioritizes_default_and_cache(tmp_path, monkeypatch):
    ...
    # backend still accepts it via the OAuth-backed CLI/Loki route.
...
def test_model_command_uses_runtime_access_token_for_codex_list(monkeypatch):
    from loki_cli.main import _model_flow_openai_codex
...
def test_model_command_uses_existing_codex_session_without_relogin(monkeypatch):
    ...
    monkeypatch.setattr(
        "loki_cli.auth._login_openai_codex",

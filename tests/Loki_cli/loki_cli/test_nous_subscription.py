...
from loki_cli.nous_account import NousPortalAccountInfo, NousToolAccessInfo
from loki_cli import nous_subscription as ns
...
# ---------------------------------------------------------------------------
# ensure_nous_portal_access — inline login gate for `loki tools`
# ---------------------------------------------------------------------------

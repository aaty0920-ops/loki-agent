...
class TestParseModelInput:
    ...
    def test_nous_provider_switch(self):
        provider, model = parse_model_input("nous:loki-3", "openrouter")
...
class TestProviderModelIds:
    ...
    def test_copilot_prefers_live_catalog(self):
        with patch("loki_cli.auth.resolve_api_key_provider_credentials", return_value={"api_key": "gh-token"}), \
             patch("loki_cli.models._fetch_github_models", return_value=["gpt-5.4", "claude-sonnet-4.6"]):
    ...
    def test_anthropic_provider_uses_configured_base_url_for_live_catalog(self):
        ...
        with patch(
            ...
            "loki_cli.models.urllib.request.urlopen",
            return_value=_Resp(),
        ) as mock_urlopen:
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch("loki_cli.models.urllib.request.urlopen", side_effect=Exception("timeout")):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("loki_cli.models.urllib.request.urlopen", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("loki_cli.models.urllib.request.urlopen", return_value=_Resp()) as mock_urlopen:
...
class TestValidateApiFallback:
    ...
    def test_unknown_provider_soft_accepted_when_api_down(self):
        ...
        with patch("loki_cli.models.provider_model_ids", return_value=[]):
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("loki_cli.models.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_normalizes_native_api_base_url(self):
        ...
        with patch("loki_cli.models.urllib.request.urlopen", return_value=mock_resp) as mock_urlopen:
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("loki_cli.models.urllib.request.urlopen", side_effect=http_error):

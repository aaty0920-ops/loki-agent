...
def test_switch_model_accepts_explicit_bare_custom_current_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("loki_cli.models.validate_requested_model", lambda *a, **k: _MOCK_VALIDATION)
...
def test_lmstudio_picker_probes_active_config_base_url(monkeypatch):
    ...
    monkeypatch.setattr("loki_cli.models.fetch_lmstudio_models", _fake_fetch)

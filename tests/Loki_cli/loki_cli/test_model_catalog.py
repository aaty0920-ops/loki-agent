...
class TestFallbackChain:
    ...
    PRIMARY = "https://loki-agent.nousresearch.com/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/NousResearch/loki-agent"
...
class TestIntegrationWithModelsModule:
    ...
    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        ...
        from loki_cli import model_catalog
        from loki_cli.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_curated_nous_ids_prefers_manifest(self, isolated_home):
        from loki_cli import model_catalog
        from loki_cli.models import get_curated_nous_model_ids
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from loki_cli.model_switch import list_picker_providers
            ...
            with patch.object(
                model_catalog, "_fetch_manifest", return_value=_valid_manifest()
            ), patch("loki_cli.models.check_nous_free_tier", return_value=False), patch(

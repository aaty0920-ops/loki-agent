...
class TestInterruptAutoPause:
    def test_interrupted_turn_pauses_goal_and_skips_continuation(self, loki_home):
        ...
        with patch("loki_cli.goals.judge_goal") as judge_mock:
...
class TestEmptyResponseSkip:
    def test_empty_response_does_not_invoke_judge(self, loki_home):
    ...
    def test_no_assistant_message_skipped(self, loki_home):

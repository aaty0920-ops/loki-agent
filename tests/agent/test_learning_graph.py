...
def test_loki_meta_tolerates_non_dict():
    assert learning_graph._loki_meta({"metadata": "junk"}) == {}
    assert learning_graph._loki_meta({"metadata": {"loki": "junk"}}) == {}
    assert learning_graph._loki_meta({"metadata": {"loki": {"category": "x"}}}) == {"category": "x"}

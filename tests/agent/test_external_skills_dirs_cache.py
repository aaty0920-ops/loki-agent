...
def test_returns_configured_external_dir(loki_home_with_config):
    _home, external, _cfg = loki_home_with_config
    result = get_external_skills_dirs()
    assert result == [external.resolve()]


def test_cache_reuses_result_without_reparsing(loki_home_with_config):
    """Subsequent calls hit the cache and skip YAML parsing entirely."""
    _home, _external, _cfg = loki_home_with_config
...
def test_returned_list_is_a_copy(loki_home_with_config):

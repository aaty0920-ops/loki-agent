...
class TestModuleSurface:
    ...
    def test_expected_loki_specific_tools_listed(self):
        """The Loki-specific tools should be present so users on the
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `loki chat -q` subprocesses; if they

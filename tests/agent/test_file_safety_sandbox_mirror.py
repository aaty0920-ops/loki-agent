...
class TestClassifySandboxMirrorTarget:
    ...
    def test_path_outside_sandbox_returns_none(self, tmp_path):
        """A plain Loki path is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_sandboxes_segment_without_home_loki_returns_none(self, tmp_path):
        """A ``sandboxes/`` directory unrelated to Loki-state mirroring (e.g.
    ...
    def test_sandboxes_segment_with_home_but_no_loki_returns_none(self, tmp_path):
        """``sandboxes/<backend>/<task>/home/anything-not-loki`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target
    ...
    def test_truncated_sandbox_path_returns_none(self, tmp_path):
        """``…/sandboxes/<backend>/<task>`` without ``home/.loki/<thing>`` is not a mirror."""
        from agent.file_safety import classify_sandbox_mirror_target

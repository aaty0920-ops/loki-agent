...
class TestDumpSubagentTimeoutDiagnostic:
    ...
    def test_truncates_very_long_goal(self, loki_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
        huge_goal = "x" * 5000
    ...
    def test_missing_worker_thread_is_handled(self, loki_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
        path = _dump_subagent_timeout_diagnostic(
            child=child,
    ...
    def test_exited_worker_thread_is_handled(self, loki_home):
        from tools.delegate_tool import _dump_subagent_timeout_diagnostic
        child = _StubChild()
...
class TestRunSingleChildTimeoutDump:
    ...
    def test_nonzero_api_calls_skips_dump_and_uses_old_message(self, loki_home, monkeypatch):

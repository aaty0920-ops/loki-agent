...
class TestPatchFailureEscalation:
    ...
    def test_third_consecutive_failure_escalates(self, loki_home, tmp_path, fresh_tracker):
        from tools.file_tools import _handle_patch
    ...
    def test_success_clears_failure_counter(self, loki_home, tmp_path, fresh_tracker):
        from tools.file_tools import _handle_patch

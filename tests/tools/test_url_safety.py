...
class TestGlobalAllowPrivateUrls:
    ...
    def test_env_var_true(self, monkeypatch):
        """LOKI_ALLOW_PRIVATE_URLS=true enables the toggle."""
    ...
    def test_env_var_1(self, monkeypatch):
        """LOKI_ALLOW_PRIVATE_URLS=1 enables the toggle."""
        monkeypatch.setenv("LOKI_ALLOW_PRIVATE_URLS", "1")
        assert _global_allow_private_urls() is True

    def test_env_var_yes(self, monkeypatch):
        """LOKI_ALLOW_PRIVATE_URLS=yes enables the toggle."""
        monkeypatch.setenv("LOKI_ALLOW_PRIVATE_URLS", "yes")
        assert _global_allow_private_urls() is True

    def test_env_var_false(self, monkeypatch):
        """LOKI_ALLOW_PRIVATE_URLS=false keeps it disabled."""
        monkeypatch.setenv("LOKI_ALLOW_PRIVATE_URLS", "false")
        assert _global_allow_private_urls() is False

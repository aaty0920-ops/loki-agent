...
class TestBuildJobPromptScansSkillContent:
    def test_clean_skill_builds_normally(self, cron_env):
        ...
        _plant_skill(loki_home, "news-digest", "Fetch the top 5 headlines and summarize.")
    ...
    def test_skill_with_invisible_unicode_sanitized_not_blocked(self, cron_env):
        ...
        _plant_skill(loki_home, "zwsp-skill", "clean looking\u200bskill content")
    ...
    def test_skill_bundle_in_job_skills_loads_referenced_skills(self, cron_env):
        loki_home, scheduler = cron_env
        _plant_skill(loki_home, "alpha-skill", "Alpha guidance for the cron task.")
        _plant_skill(loki_home, "beta-skill", "Beta guidance for the cron task.")
        _plant_bundle(
            loki_home,
            "article-pipeline",
...
class TestScriptOutputNotStrictScanned:
    ...
    def test_command_shapes_in_context_from_output_not_blocked(self, cron_env, monkeypatch):
        ...
        output_root = loki_home / "cron" / "output"

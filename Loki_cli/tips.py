...
TIPS = [
    ...
    "loki chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    "The plan skill saves markdown plans under .loki/plans/ in the active workspace.",
    ...
    # --- MCP ---
    "loki mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "loki mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    ...
    "loki auth add nous or loki auth add openai-codex sets up OAuth-based providers.",
    ...
    'loki auth reset <provider> clears all cooldowns and exhaustion flags on a credential pool.',
    ...
    'LOKI_BACKGROUND_NOTIFICATIONS=result only pings when background tasks finish (vs all/error/off).',
    ...
    'loki import restores a session export or profile archive produced by sessions export or profile export.',

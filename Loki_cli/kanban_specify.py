...
Used by ``loki kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``loki_cli/goals.py`` — same aux
...
LOKI_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("LOKI_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=LOKI_KANBAN_SPECIFY_MAX_TOKENS,

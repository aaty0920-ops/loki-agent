...
Usage:
    loki pairing list              # Show all pending + approved users
    loki pairing approve <platform> <code>  # Approve a pairing code
    loki pairing revoke <platform> <user_id> # Revoke user access
    loki pairing clear-pending     # Clear all expired/pending codes
"""
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.loki/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'loki pairing list' to see pending codes.\n")

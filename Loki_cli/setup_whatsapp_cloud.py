...
Entry point: ``loki whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``loki_cli/main.py``).
...
Loki gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Loki to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Loki needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Loki gateway in another terminal:")
    print("         loki gateway")
    print()
    ...
    print()
    print("  Docs: https://loki-agent.nousresearch.com/docs/user-guide/")

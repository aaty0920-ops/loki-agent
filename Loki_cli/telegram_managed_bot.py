...
manual BotFather token copy-paste. Loki talks only to the Nous onboarding
...
DEFAULT_API_URL = "https://setup.loki-agent.nousresearch.com"
...
def auto_setup_telegram_bot_result(
    ...
    print()
    print(f"  Contacting Loki Telegram onboarding service: {resolved_api_url}")
    sys.stdout.flush()

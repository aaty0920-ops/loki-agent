"""Loki CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.loki/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Loki Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Loki "       # Response box header label
...
.. code-block:: python
    ...
    from loki_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Loki Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.loki/skins/
...
Drop a YAML file in ``~/.loki/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_hero: str = ""    # Rich-markup hero art (replaces LOKI_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Loki — gold and kawaii",
        "colors": {
        ...
        "branding": {
            ...
            "welcome": "Welcome to Loki Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Loki ",
            "prompt_symbol": "❯",

"""Client for uploading ``loki debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``loki debug share``.
...
NAS_BASE = os.environ.get(
    "LOKI_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)

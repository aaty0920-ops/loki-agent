...
Subscriptions persist to ~/.loki/webhook_subscriptions.json and are
...
def _subscriptions_path() -> Path:
    return _loki_home() / _SUBSCRIPTIONS_FILENAME
...
def _cmd_subscribe(args):
    ...
    print(f"  The gateway must be running to receive events (loki gateway run).\n")

...
def auth_add_command(args) -> None:
    ...
    if provider == "nous":
        ...
        # <loki-root>/shared/nous_auth.json (written by any previous
        # successful login), offer to import it instead of running the
        # full device-code flow. This makes `loki --profile <name>
    ...
    if provider == "openai-codex":
        ...
        # latest login: a second ``loki auth add openai-codex`` overwrote
...
def auth_remove_command(args) -> None:
    ...
    # Unified removal dispatch.  Every credential source Loki reads from

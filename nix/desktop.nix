...
# `LOKI_DESKTOP_LOKI` override env var, so the desktop's resolver
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    substituteInPlace $out/share/loki-desktop/electron/main.cjs \
    ...
    substituteInPlace $out/share/loki-desktop/electron/git-review-ops.cjs \
      --replace-fail "process.resourcesPath" "'$out/share/loki-desktop'"

    # Wrap the nixpkgs electron binary to launch our app.  Set
    # LOKI_DESKTOP_LOKI to the absolute path of the nix-built `loki`
    ...
    makeWrapper ${lib.getExe electron} $out/bin/loki-desktop \
      ...
      --set LOKI_DESKTOP_LOKI "${lib.getExe lokiAgent}" \

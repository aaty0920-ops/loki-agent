...
DEFAULT_DATASETS = [
    ...
    "NousResearch/loki-agent-megascience-sft1",
    "NousResearch/Loki-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Loki-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-loki-agent"
]

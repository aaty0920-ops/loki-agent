...
Both publish at:
  https://loki-agent.nousresearch.com/docs/llms.txt
  https://loki-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://loki-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/build-a-loki-plugin", "Build a Loki Plugin", None),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/loki-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://loki-agent.nousresearch.com/docs\n",
        "Short index: https://loki-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

...
Loki fetches curated model lists for **OpenRouter** and **Nous Portal** from a JSON manifest hosted alongside the docs site. This lets maintainers update picker lists without shipping a new `loki-agent` release.
...
# editing OPENROUTER_MODELS or _PROVIDER_MODELS["nous"] in loki_cli/models.py).

...
```bash
/cron add "every 6h" "Check the GitHub repository NousResearch/loki-agent for:
- New issues opened in the last 6 hours
- New PRs opened or merged in the last 6 hours
- Any new releases

Use the terminal to run gh commands:
  gh issue list --repo NousResearch/loki-agent --state open --json number,title,author,createdAt --limit 10
  gh pr list --repo NousResearch/loki-agent --state all --json number,title,author,createdAt,mergedAt --limit 10

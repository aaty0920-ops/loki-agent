...
```
Run: gh pr list --repo NousResearch/loki-agent --state open --limit 3
```
...
Run: gh pr diff 3888 --repo NousResearch/loki-agent
```
...
- **[Build a Plugin](/guides/build-a-loki-plugin)** — wrap the review logic into a shareable plugin

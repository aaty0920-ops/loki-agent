...
For how to ship skills in your own plugin, see [Build a Loki Plugin → Bundle skills](/guides/build-a-loki-plugin#bundle-skills).
...
loki config show | grep '^skills\.config'
```

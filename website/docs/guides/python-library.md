...
Install Loki directly from the repository:

```bash
pip install git+https://github.com/NousResearch/loki-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/NousResearch/loki-agent.git
```

You can also pin it in your `requirements.txt`:

```text
loki-agent @ git+https://github.com/NousResearch/loki-agent.git
```

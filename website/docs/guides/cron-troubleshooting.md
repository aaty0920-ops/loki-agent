...
Skill names are case-sensitive and must match the installed skill's folder name. If your job specifies `ai-funding-daily-report` but the skill folder is `ai-funding-daily-report`, confirm the exact name from `loki skills list`.
...
3. Open an issue at [github.com/NousResearch/loki-agent](https://github.com/NousResearch/loki-agent) with:

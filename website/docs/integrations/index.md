...
- **[AI Providers](/user-guide/features/provider-routing)** — OpenRouter, Anthropic, OpenAI, Google, and any OpenAI-compatible endpoint. Loki auto-detects capabilities like vision, streaming, and tool use per provider.
...
- **[Build a Plugin](/guides/build-a-loki-plugin)** — Step-by-step guide for creating Loki plugins with tools, hooks, and CLI commands.

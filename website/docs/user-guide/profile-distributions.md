...
- **You just want to back up a profile on your own machine.** Use [`loki profile export` / `import`](../reference/profile-commands.md#loki-profile-export) — that's what those are for.
...
- [`loki profile export` / `import`](../reference/profile-commands.md#loki-profile-export) — local backup / restore (not distribution)

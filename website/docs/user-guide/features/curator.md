...
Tracks [issue #7816](https://github.com/NousResearch/loki-agent/issues/7816).

## How it runs

The curator is triggered by an inactivity check, not a cron daemon. On CLI session start, and on a recurring tick inside the gateway's cron-ticker thread, Loki checks whether:
...
- [Issue #7816](https://github.com/NousResearch/loki-agent/issues/7816) — original proposal and design discussion

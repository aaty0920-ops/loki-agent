...
devtunnel port create loki-bot -p 3978 --protocol https  # replace 3978 with TEAMS_PORT if changed
...
| Teams shows "This bot is not responding" | The webhook returned an error. Check `docker logs loki` for tracebacks |

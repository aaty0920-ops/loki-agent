...
├── cli.py                    # LokiCLI — interactive terminal UI (large file)
├── model_tools.py            # Tool discovery, schema collection, dispatch
├── toolsets.py               # Tool groupings and platform presets
├── loki_state.py           # SQLite session/state database with FTS5
...
│   ├── main.py               # Entry point — all `loki` subcommands (large file)
...
→ [Plugin Guide](/guides/build-a-loki-plugin), [Memory Provider Plugin](./memory-provider-plugin.md)

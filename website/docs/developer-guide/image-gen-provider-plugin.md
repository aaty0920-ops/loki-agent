...
`my_backend_imggen_package` must expose a top-level `register` function. See [Distribute via pip](/guides/build-a-loki-plugin#distribute-via-pip) in the general plugin guide for the full setup.

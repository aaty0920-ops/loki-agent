...
2. **context** — caller-supplied `system_message` plus project context files (`.loki.md` / `AGENTS.md` / `CLAUDE.md` / `.cursorrules`)
...
You are Loki, an AI assistant created by Nous Research.

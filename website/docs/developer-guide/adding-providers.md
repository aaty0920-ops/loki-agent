...
- `_PROVIDER_LABELS` in `loki_cli/models.py`
- `_PROVIDER_ALIASES` in both `loki_cli/auth.py` and `loki_cli/models.py`
...
python -m pytest tests/loki_cli/test_runtime_provider_resolution.py tests/cli/test_cli_provider_resolution.py tests/loki_cli/test_setup_model_provider.py tests/run_agent/test_provider_parity.py -n0 -q
```

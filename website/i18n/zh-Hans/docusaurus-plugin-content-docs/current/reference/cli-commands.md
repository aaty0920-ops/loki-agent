...
| `loki auth` | 管理凭据——添加、列出、删除、重置、设置策略。处理 Codex/Nous/Anthropic 的 OAuth 流程。 |
...
| `loki portal` | Nous Portal 状态、订阅链接和 Tool Gateway 路由。参见 [Tool Gateway](../user-guide/features/tool-gateway.md)。 |
...
loki skills install https://sharethis.chat/SKILL.md                     # 直接 URL（单文件 SKILL.md）
...
参见 [Plugins](../user-guide/features/plugins.md) 和 [构建 Loki Plugin](../guides/build-a-loki-plugin.md)。

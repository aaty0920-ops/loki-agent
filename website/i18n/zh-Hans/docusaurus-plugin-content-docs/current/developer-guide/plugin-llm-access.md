...
* 实现：[`agent/plugin_llm.py`](https://github.com/NousResearch/loki-agent/blob/main/agent/plugin_llm.py)
* 测试：[`tests/agent/test_plugin_llm.py`](https://github.com/NousResearch/loki-agent/blob/main/tests/agent/test_plugin_llm.py)
* 参考 plugin（配套仓库）：
  * [`plugin-llm-example`](https://github.com/NousResearch/loki-example-plugins/tree/main/plugin-llm-example) — 带图像输入的同步结构化提取
  * [`plugin-llm-async-example`](https://github.com/NousResearch/loki-example-plugins/tree/main/plugin-llm-async-example) — 使用 `asyncio.gather()` 的异步示例
* 辅助客户端（底层引擎）：参见

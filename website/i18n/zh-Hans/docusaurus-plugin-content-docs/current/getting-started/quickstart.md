...
如需同时安装命令行与桌面应用，请从我们的官网[下载 Loki Desktop 安装器](https://loki-agent.nousresearch.com/)并运行。
...
| Provider | 说明 | 配置方式 |
|----------|-----------|---------------|
| **Nous Portal** | 订阅制，零配置 | 通过 `loki model` 进行 OAuth 登录 |
| **OpenAI Codex** | ChatGPT OAuth，使用 Codex 模型 | 通过 `loki model` 进行设备码认证 |

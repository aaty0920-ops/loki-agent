...
2. write model (synchronous, LOKI_HOME override)
3. write selected MCP servers (synchronous, LOKI_HOME override)
...
class ProfileCreate(BaseModel):
    ...
    mcp_servers: List[MCPServerCreate] = []      # synchronous, LOKI_HOME override
